...
public class AdditionalExaminationController {
    ...
    public String addAdditionalExamination(@PathVariable Long id, @ModelAttribute(name = "additionalExamination") @Validated AdditionalExamination additionalExamination,  BindingResult result) {
        if (result.hasErrors()) {
            return "additionalExamination/addAdditional";
        } else {
